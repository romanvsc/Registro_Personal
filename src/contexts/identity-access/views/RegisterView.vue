...
.register-story { position: relative; display: flex; flex-direction: column; align-items: center; justify-content: center; overflow: hidden; padding: 48px; border-right: 1px solid var(--dorito-100); background: #fdf7ec; }
.register-brand { z-index: 1; display: flex; align-items: center; gap: 16px; width: min(560px, 100%); }
.register-brand > span { display: grid; place-items: center; width: 62px; height: 62px; border-radius: 18px; color: white; background: linear-gradient(145deg, var(--dorito-400), var(--dorito-600)); font-size: 30px; }
.register-brand strong { display: block; color: var(--cocoa-950); font: 800 clamp(30px, 3vw, 46px)/1 Nunito; }.register-brand em { color: var(--dorito-500); font-style: normal; }.register-brand small { display: block; margin-top: 9px; color: var(--cocoa-600); }
.register-cats { width: min(650px, 112%); margin-top: 24px; aspect-ratio: 4/3; object-fit: cover; -webkit-mask-image: radial-gradient(ellipse 70% 68% at center, #000 60%, transparent 100%); mask-image: radial-gradient(ellipse 70% 68% at center, #000 60%, transparent 100%); }
blockquote { margin: -24px 0 0; color: var(--cocoa-950); font: 700 clamp(25px, 2.5vw, 38px) Georgia, serif; }
.register-access { display: grid; place-items: center; min-height: 100vh; padding: 24px; background: linear-gradient(135deg, var(--sand-50), var(--cream-100)); }
.register-card { width: min(720px, 100%); padding: clamp(36px, 5vh, 64px) clamp(34px, 6vw, 78px); border: 1px solid rgba(232,220,203,.65); border-radius: 30px; background: rgba(255,255,255,.86); box-shadow: var(--shadow-float); }
.welcome-pill { display: inline-flex; align-items: center; gap: 9px; min-height: 42px; padding: 0 16px; border: 1px solid var(--dorito-100); border-radius: 22px; color: var(--dorito-600); background: var(--dorito-50); font-weight: 700; }
h1 { margin: 22px 0 8px; color: var(--cocoa-950); font: 800 clamp(32px, 3vw, 44px)/1.1 Nunito; }.register-subtitle { margin: 0 0 26px; color: var(--cocoa-600); line-height: 1.5; }
form > label { display: block; margin-top: 18px; color: var(--cocoa-900); font-weight: 700; }
.register-input { display: grid; grid-template-columns: 30px minmax(0, 1fr) auto; align-items: center; gap: 11px; min-height: 58px; margin-top: 8px; padding: 0 14px; border: 1px solid var(--sand-400, #B7A08D); border-radius: 12px; color: var(--dorito-500); background: #fff; box-shadow: inset 0 1px 0 rgba(255,255,255,.9); transition: border-color .2s, box-shadow .2s, background-color .2s; }
.register-input:focus-within { border-color: var(--dorito-400); box-shadow: 0 0 0 4px rgba(217,120,34,.1); }.register-input img { width: 30px; height: 30px; object-fit: contain; }.register-input input { min-width: 0; width: 100%; border: 0; outline: 0; color: var(--cocoa-900); background: transparent; font-size: 16px; }.register-input button { padding: 7px; border: 0; color: var(--cocoa-400); background: transparent; cursor: pointer; }
.register-input input::placeholder { color: var(--cocoa-500, #928075); opacity: 1; }.register-input button { display: inline-grid; place-items: center; min-width: 44px; min-height: 44px; margin-right: -10px; color: var(--cocoa-600); border-radius: 10px; }.register-input button:focus-visible, .register-submit:focus-visible, .login-prompt a:focus-visible { outline: 3px solid var(--dorito-300); outline-offset: 3px; }
.password-help { margin: 7px 0 0; color: var(--cocoa-600); font-size: 13px; }.register-error { margin: 14px 0 0; color: var(--danger-600); font-size: 14px; }
.register-submit { display: flex; align-items: center; justify-content: center; gap: 11px; width: 100%; min-height: 60px; margin-top: 26px; border: 0; border-radius: 12px; color: white; background: linear-gradient(90deg, var(--dorito-400), var(--dorito-600)); box-shadow: 0 10px 24px rgba(185,93,23,.18); font-size: 18px; font-weight: 800; cursor: pointer; }.register-submit:disabled { opacity: .68; cursor: wait; }.register-submit img { width: 34px; height: 34px; object-fit: contain; }
