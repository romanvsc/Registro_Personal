...
.reset-page { background: var(--cream-100); }
.reset-card { border: 3px solid var(--cocoa-950); border-radius: 12px; background: var(--cream-50); box-shadow: 6px 6px 0 var(--cocoa-950); }
.reset-mark { border: 3px solid var(--cocoa-950); border-radius: 14px; background: var(--dorito-500); box-shadow: 4px 4px 0 var(--cocoa-950); }
.reset-input { border: 2px solid var(--cocoa-900); border-radius: 9px; background: var(--cream-50); box-shadow: none; }
.reset-input:focus-within { border-color: var(--dorito-600); outline: 3px solid var(--dorito-300); outline-offset: 2px; box-shadow: none; }
.reset-primary { border: 2px solid var(--cocoa-950); border-radius: 9px; background: var(--dorito-500); box-shadow: 4px 4px 0 var(--cocoa-950); transition: transform .16s ease, box-shadow .16s ease, background-color .16s ease; }
.reset-primary:hover:not(:disabled) { transform: translate(2px, 2px); box-shadow: 2px 2px 0 var(--cocoa-950); }
.reset-secondary { padding: 2px 6px; border: 2px solid var(--cocoa-950); border-radius: 6px; color: var(--cocoa-950); background: var(--lavender-100, #ece8ff); }
.reset-error { padding: 9px 12px; border: 2px solid var(--danger-600); border-left-width: 6px; color: var(--danger-700, #874033); background: var(--danger-50, #fff0ec); font-weight: 700; }
.reset-primary:focus-visible, .reset-secondary:focus-visible, .reset-input button:focus-visible { outline: 3px solid var(--dorito-600); outline-offset: 3px; }
